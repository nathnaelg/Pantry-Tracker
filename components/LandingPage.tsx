        ...
        <Container maxWidth="lg" className="py-20">
            <Box className="text-center">
                ...
                <Typography variant="h5" component="p" className="mb-12">
                    Easily manage your Inventory items and keep track of what you have.
                </Typography>
            ...
            <Box className="mt-20 grid grid-cols-1 md:grid-cols-3 gap-8">
                <Box className="text-center">
                    ...
                    <Typography variant="body1" component="p">
                        Our user-friendly interface makes managing your Inventory a breeze.
                    </Typography>
                </Box>
                <Box className="text-center">
                    ...
                    <Typography variant="body1" component="p">
                        Keep an inventory of all your Inventory items with ease.
                    </Typography>
                </Box>
                <Box className="text-center">
                    ...
                    <Typography variant="body1" component="p">
                        Get new great recipes generated by AI, considering your items in the Inventory.
                    </Typography>
                </Box>
            </Box>
        </Container>
